...
import 'package:flutterdemo/widget/keys/stateful_color.dart';
import 'package:flutterdemo/widget/keys/stateless_color.dart';
...
class _SwapColorDemo1State extends State<SwapColorDemo1> {
  ...
  void initState() {
    super.initState();
    widgets = [const StatefulColor(), const StatefulColor()];
  }
